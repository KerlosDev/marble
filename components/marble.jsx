...
const Marble = () => {
    ...
    const firstGalleryImages = [
        { src: "/marble.jpg", alt: "Premium Egyptian Marble" },
        { src: "/marble2.jpg", alt: "Luxury Marble" },
        { src: "/slide three.jpg", alt: "Natural Marble" },
        { src: "/first.jpeg", alt: "Premium Stone" }
    ];

    // Slideshow state for second gallery
    const [currentSlideSecond, setCurrentSlideSecond] = React.useState(0);
    const secondGalleryImages = [
        { src: "/marble.jpg", alt: "Premium Egyptian Marble" },
        { src: "/marble2.jpg", alt: "Natural Granite" },
        { src: "/slide three.jpg", alt: "Premium Granite" },
        { src: "/first.jpeg", alt: "Natural Stone" }
    ];
    ...
    // Auto-slideshow effect for second gallery (offset timing)
    React.useEffect(() => {
        const interval = setInterval(() => {
            setCurrentSlideSecond((prev) => (prev + 1) % secondGalleryImages.length);
            ...
            <div className="relative z-10 flex flex-col md:flex-row font-rubik items-center justify-between px-4 py-16 md:py-24 max-w-7xl mx-auto gap-8">
                ...
                <div className="w-full md:w-1/2 text-right mt-8 md:mt-0 md:pr-8 space-y-6 rtl">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h1 className="text-5xl md:text-5xl font-bold text-white pb-2 inline-block drop-shadow-lg">الرخام والاحجار الطبيعية </h1>
                    </motion.div>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: true }}
                    >
                        رخام الفارس يتميز بجودة عالية وتصاميم طبيعية تضيف لمسة من الفخامة لكل مساحة.
                    </motion.p>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: true }}
                    >
                        نقدم لكم تشكيلات متنوعة تناسب جميع الأذواق من الأرضيات إلى الجدران والديكورات الداخلية.
                        مع خبرتنا الطويلة، نضمن لعملائنا المتانة، الجمال، والدقة في كل قطعة حجر طبيعي.
                    </motion.p>
            ...
            <div className="relative z-10 flex flex-col md:flex-row font-rubik items-center justify-between px-4 py-16 md:py-24 max-w-7xl mx-auto gap-8">
                ...
                <div className="w-full md:w-1/2 text-right mt-8 md:mt-0 md:pr-8 space-y-6 rtl">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h1 className="text-5xl md:text-5xl font-bold text-white pb-2 inline-block drop-shadow-lg">جرانيت طبيعي</h1>
                    </motion.div>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: true }}
                    >
                        نوفر تشكيلات متنوعة تناسب المطابخ، الأرضيات، والواجهات بألوان ونقوش مميزة.
                        مع جودة مضمونة، نقدم لك حجرًا طبيعيًا يجمع بين الأناقة والمتانة ليدوم لسنوات طويلة.
                    </motion.p>
                ...
                <div className="w-full md:w-1/2 flex justify-center md:justify-end">
                    ...
                    >
                        <AnimatePresence mode="wait" custom={1}>
                            ...
                            >
                                <Image
                                    src={secondGalleryImages[currentSlideSecond].src}
                                    alt={secondGalleryImages[currentSlideSecond].alt}
                                    fill
                                    className="object-cover filter drop-shadow-2xl rounded-3xl"
                                    priority={currentSlideSecond === 0}
                                />
                        ...
                        {/* Slide indicators for second gallery */}
                        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2 z-10">
                            {secondGalleryImages.map((_, index) => (
                                <button
                                    key={index}
                                    onClick={() => setCurrentSlideSecond(index)}
                                    className={`w-2 h-2 rounded-full transition-all duration-300 ${
                                        currentSlideSecond === index 
                                            ? 'bg-white scale-125' 
                                            : 'bg-white/50 hover:bg-white/75'
                                    }`}
                                />
                        ...
                        {/* Progress bar for second gallery */}
                        <div className="absolute bottom-0 left-0 w-full h-1 bg-white/20 rounded-b-3xl">
                            <motion.div
                                className="h-full bg-white rounded-b-3xl"
                                initial={{ width: "0%" }}
